...
rns: main.o rns_env.o rns_add.o rns_sub.o rns_mul.o add_int128.o sub_int128.o divide_int128_by_10.o load_int128.o is_int128_zero.o copy_int128.o shl_int128.o read_int128.o int_to_rns.o utils.o
	gcc ${CFLAGS} -o $@ $^
